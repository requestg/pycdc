...
CMAKE_SOURCE_DIR = /sdcard/data/pycdc

# The top-level build directory on which CMake was run.
CMAKE_BINARY_DIR = /sdcard/data/pycdc
...
all: cmake_check_build_system
	$(CMAKE_COMMAND) -E cmake_progress_start /sdcard/data/pycdc/CMakeFiles /sdcard/data/pycdc//CMakeFiles/progress.marks
	$(MAKE) $(MAKESILENT) -f CMakeFiles/Makefile2 all
	$(CMAKE_COMMAND) -E cmake_progress_start /sdcard/data/pycdc/CMakeFiles 0
.PHONY : all
